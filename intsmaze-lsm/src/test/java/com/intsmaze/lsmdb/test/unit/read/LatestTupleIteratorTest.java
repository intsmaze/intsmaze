...
package com.intsmaze.lsmdb.test.unit.read;
...
public class LatestTupleIteratorTest {
    ...
    private final List<Tuple> snapshotTuples = new ArrayList<Tuple>();

    public LatestTupleIteratorTest() {
        ...
        snapshotTuples.add(new Tuple(new Key(KEY_1, 3), Value.TOMBSTONE_VALUE));
        snapshotTuples.add(new Tuple(new Key(KEY_2, 4), Value.TOMBSTONE_VALUE));
    }
