package com.intsmaze.jetty.handle;//package org.intsmaze.jetty.handle;
//
//
...
//
////通过jmx工具查看，没有注册什么新的bean。
//public class ApplicationServer implements ApplicationServerBean{
//
...
//				new String[] {"dubbo/dubbo-consumer.xml","/intsmaze-jetty.xml"});
...
//		ObjectName mbeanName=getApplicationObjectName();
//		ApplicationServerBean mbean=MBeanServerInvocationHandler.newProxyInstance(mbsc, mbeanName, ApplicationServerBean.class, true);
//
//		try{
//			mbean.close();
//		} catch(Exception e)
