...
public class FDFBUserProfile extends BasePojo{
    /**
	 * 
	 */
	private static final long serialVersionUID = -3200133845457679945L;
	...
	public Timestamp getNewModifyon() {
		return newModifyon;
	}

	public void setNewModifyon(Timestamp newModifyon) {
		this.newModifyon = newModifyon;
	}
