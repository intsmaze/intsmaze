package cn.hive.bigdata.hive.inputformat;//package cn.hive.bigdata.hive.inputformat;
//
...
//	}
//
//	public BiRecordReader(InputStream in, long offset, long endOffset, int maxLineLength) {
...
//	}
//
//	public BiRecordReader(InputStream in, long offset, long endOffset, Configuration job) throws IOException {
//		this.maxLineLength = job.getInt("mapred.linerecordreader.maxlength", Integer.MAX_VALUE);
